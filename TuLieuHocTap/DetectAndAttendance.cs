        ...
        public void FrameGrabber(object sender, EventArgs e)
        {
          ...
          new Size(20, 20));
            ...
            for (int nnn = 0; nnn < facesDetected[0].Length; nnn++)
            {
                ...
                System.IO.File.AppendAllText(@"C:\Users\hungv\Downloads\Trí tuệ nhân tạo\TuLieuHocTap_2\TuLieuHocTap\TuLieuHocTap\Names\names.txt", test);
        ...
        private void SaveToDatabase(string studentID, DateTime dateTime)
        {
            ...
            using (SqlConnection Connection = new SqlConnection(@"" + line + ""))
            {
                ...
                try
                {
                    ...
                    SqlCommand getNameFromSID = new SqlCommand(@"SELECT name, makhoa, malop from STUDENT WHERE studentid=@studentid", Connection);
                    ...
                    SqlCommand cmd = new SqlCommand(@"INSERT INTO attendance ([name],[studentid],[dateandtime],makhoa, malop) VALUES (@name, @studentid, @datetime,@makhoa,@malop);", Connection);
                    ...
                    if (i == 1)
                    {
                        MessageBox.Show($"Sinh viên {studentName} đã điểm danh");
